    ...
    return (
        <div className="calendar__controls">
            <div className="calendar__controls--row">
                <Button
                    className="calendar__control calendar__control--month-change"
                    onClick={prevMonth}
                >
                    <Arrow className="left" />
                </Button>
                <span className="calendar__control--month-name">
                    {monthName}
                </span>
                <Button
                    className="calendar__control calendar__control--month-change"
                ...
                {['day', 'week', 'month'].map((calendarType) => {
                    return (
                        <Button
                            ...
                            className={
                                calendarType === currentCalendarViewType
                                    ? 'current'
                                    : ''
                            }
                            onClick={() =>
                                handleCalendarViewChange(
                                    calendarType as viewType
                                )
                            }
                        >
                            {calendarType}
